...
<!--<script src="<?= base_url('assets/web/bootstrap-3.3.7-dist/js/bootstrap.min.js') ?>"></script>-->
<?php if(isset($title) && $title == 'Product Bundles') { ?>
	<script src="https://cdnjs.cloudflare.com/ajax/libs/bootstrap-select/1.13.1/js/bootstrap-select.min.js"></script>
<?php } ?>
<script src="<?=WEB_URL.'js/Chart.min.js'?>"></script>
<script src="<?=WEB_URL.'js/custom.min.js'?>"></script>
<script src="<?=WEB_URL.'js/jquery.canvasjs.min.js'?>"></script>
