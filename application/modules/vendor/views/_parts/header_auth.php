					...
					<li class="nav-item short_filter short_filter_web">
						...
						<div class="btn-group btn-group-lg mk_l">
							<div class="dropdown">
							  ...
							  <div class="dropdown-menu">
								<a class="dropdown-item <?=(!isset($_SESSION['vendor_theme']) || (isset($_SESSION['vendor_theme']) && $_SESSION['vendor_theme']=='light'))?'active-theme':''?>" href="<?=LANG_URL.'/vendor/auth/change-theme/light'?>">
									<i class="<?=(!isset($_SESSION['vendor_theme']) || (isset($_SESSION['vendor_theme']) && $_SESSION['vendor_theme']=='light'))?'':''?>"></i> Light
								</a>
								<a class="dropdown-item <?=(isset($_SESSION['vendor_theme']) && $_SESSION['vendor_theme']=='dark')?'active-theme':''?>" href="<?=LANG_URL.'/vendor/auth/change-theme/dark'?>">
