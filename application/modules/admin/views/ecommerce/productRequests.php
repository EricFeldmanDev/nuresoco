<div id="products">
    ...
    ?>
    <h1><img src="<?= base_url('assets/imgs/products-img.png') ?>" class="header-img" style="margin-top:-2px;"> Product Requests</h1>
    <hr>
    <div class="row">
        <div class="col-xs-12">
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <div class="pull-right">
                                            <a href="<?= base_url('admin/productRequests?accept=' . base64_encode($row->product_id)) ?>"  class="btn btn-primary" onclick="return confirm('Are you sure to confirm this product?')">Accept</a>
                                            <a href="<?= base_url('admin/productRequests?reject=' . base64_encode($row->product_id)) ?>"  class="btn btn-danger" onclick="return confirm('Are you sure to reject this product?')">Reject</a>
											<div class="clearfix"></div><br>
                                            <a href="javascript:void(0)<?php //echo base_url('admin/publish/' . $row->product_id) ?>" class="btn btn-info">View</a>
                                            <a href="<?= base_url('admin/productRequests?delete=' . base64_encode($row->product_id)) ?>"  class="btn btn-danger confirm-delete">Delete</a>
                                        </div>
                                    </td>
                                </tr>
                                <?php
