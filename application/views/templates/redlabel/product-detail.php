    	 ...
    	 $(document).ready(function() {
			...
			<div class="col-md-6 detials_right">
				...
				<div class="add_and_buy_btn">
					...
					<a class="option_1" data-goto="<?=base_url('shopping-cart')?>" href="javascript:void(0);" data-id="<?= $products_detail['product_id'] ?>">
				...
				<!--<div class="express_btn">
				    <button type="button" class="btn btn-primary">
					    <img src="<?=WEB_URL?>images/express.png"/>
					    <div class="wx_e"><h6>Express Delivery</h6><small>Get 5-7 days for this product</small></div>
					</button>
				    <button type="button" class="btn btn-primary">
					    <img src="<?=WEB_URL?>images/verify.png"/>  
					    <div class="wx_e"><h6>Verified</h6><small>Verified by Nureso Shoppers</small></div>
					</button> 
				</div>-->	
				...
				<section class="rating_and_reviews_section">
					<div class="col-md-6 rating_and_reviews_left">
						...
						<div class="bg_white similar_w">
							<div class="row"> 
								<div class="col-md-12">  
									<h4 class="bold">Similar Product</h4>
									<div id="product_section">
									<?php foreach($relatedProducts as $relatedProduct){ $id=base64_encode($relatedProduct['product_id']);?>	
										<div class="col-md-6 col-sm-6 col-lg-4 col-xl-3 product_ak wow fadeInUp" title="<?=$relatedProduct['product_name']?>">
											<div class="row">
